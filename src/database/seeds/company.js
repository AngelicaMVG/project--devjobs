const data = [
  {
    ...
    description:
      "Our business grows milestones to reliably and effectively facilitate our wholesale user experience. Iteratively touching base about leveraging verticals will make us leaders in the mission critical enterprise industry. Efficiencies will come from strategically investing our clouds.",
...
exports.seed = function(knex, Promise) {
  return knex("company")
    .del()
    .then(() => {
      return knex("company").insert(data);
    });
};
